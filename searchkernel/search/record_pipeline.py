...
class RecordSearchPipeline:
    ...
    def __init__(
        ...
        *,
        ...
        self._candidate_acquisition = CandidateAcquisition(
            self,
            _raw_pre_fusion_overlap,
        )
    ...
    async def _acquire_candidates(self, execution: _SearchExecution) -> None:
        await self._candidate_acquisition._acquire_candidates(execution)
    ...
    async def async_search(
        ...
        *,
        ...
        await self._candidate_acquisition.run(execution)
